...
<body class="container bg-dark text-light">
    ...
    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav me-auto text-white">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('entrainements.index') }}">Entrainements</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('entrainementsJoueur.index') }}">Entrainements Joueur</a>
                        </li>
                        <li class="nav-item">
